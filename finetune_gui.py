...
def train_model(
    ...
    if generate_caption_database:
        ...
        run_cmd = ['python', '/content/gdrive/MyDrive/SD-Data/KohyaGUI/finetune/merge_captions_to_metadata.py']
    ...
    if generate_image_buckets:
        run_cmd = [f'python', '/content/gdrive/MyDrive/SD-Data/KohyaGUI/finetune/prepare_buckets_latents.py']
        run_cmd.append(str(image_folder))
        run_cmd.append(f'{train_dir}/{caption_metadata_filename}')
    ...
    run_cmd = [f'python', '/content/gdrive/MyDrive/SD-Data/KohyaGUI/fine_tune.py']
    if v2:
        run_cmd.append('--v2')
